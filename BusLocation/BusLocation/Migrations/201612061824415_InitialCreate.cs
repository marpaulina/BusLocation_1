    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        TrackModels_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TrackModels", t => t.TrackModels_Id)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TrackModels", t => t.Track_Id)
                .Index(t => t.Track_Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        NameTrack = c.String(nullable: false),
                        BusStopId = c.Int(nullable: false),
                        TimeToNext = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
